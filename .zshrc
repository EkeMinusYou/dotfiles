...
alias ghs="gh api -X GET /user/starred --paginate --cache 24h | jq '.[].full_name' -r | fzf --reverse --height 50% | xargs gh repo view --web"
...
eval "$(fzf --zsh)"
# See: https://github.com/folke/tokyonight.nvim/blob/0fae425aaab04a5f97666bd431b96f2f19c36935/extras/fzf/tokyonight_night.zsh
